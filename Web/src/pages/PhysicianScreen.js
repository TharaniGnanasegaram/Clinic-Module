...
function PhysicianScreen(props) {
  ...
  let data = reactLocalStorage.getObject('Physician');
  ...
  function handleAdd() {
    ...
    console.log("onClickPhysicianButton", data);
    props.addPhysicians(props, data);
  };
...
export default connect(mapStateToProps, actions)(PhysicianScreen);