...
function BillingScreen(props) {
  ...
  let data = reactLocalStorage.getObject('Billing');
          ...
          <TableBody>
            {data.map((row) => (
              <TableRow key={row.name}>
                ...
                <TableCell align="center">{row.patientId}</TableCell>{/*TODO*/}
                <TableCell align="center">{row.billAmount}</TableCell>
                <TableCell align="center">{row.billedDatetime}</TableCell>
...
export default connect(mapStateToProps, actions)(BillingScreen);